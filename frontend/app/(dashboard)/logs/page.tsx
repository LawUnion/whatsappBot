...
export default function LogsPage() {
  return (
    <div className="space-y-8 pb-20 max-w-7xl mx-auto">
      <div>
        <h1 className="text-2xl font-semibold text-slate-900 tracking-tight">Activity Logs</h1>
        <p className="text-sm text-slate-500 mt-1">View admin activity history</p>
      </div>
